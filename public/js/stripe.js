(function () {
  ...
  var checkoutButton = document.getElementById(
    "checkout-button-price_1IuSoYE8f20dSLXPAE8Lguaz"
  );
  checkoutButton.addEventListener("click", function () {
    ...
    stripe
      .redirectToCheckout({
        lineItems: [{ price: "price_1IuSoYE8f20dSLXPAE8Lguaz", quantity: 1 }],
        mode: "payment",
        /*
        ...
        cancelUrl: "https://save-nessie.web.app/two-fiddy.html"
      })
